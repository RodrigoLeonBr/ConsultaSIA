...
@section('title', 'Relatório de Internações AIH')

@section('header')
<div class="flex items-center justify-between">
    <div>
        <h1 class="text-3xl font-bold text-gray-900">Relatório de Internações AIH</h1>
        <p class="text-gray-600 mt-1">Resumo das internações hospitalares (tabela s_aih)</p>
    </div>
...
@section('content')
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            <div class="flex">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-blue-800">Relatório de Internações AIH (SIHD)</h3>
                    <div class="mt-2 text-sm text-blue-700">
                        <p>Gera relatórios do <strong>resumo das internações</strong> (tabela <code>s_aih</code>) importada do SIHD.</p>
                        <p class="mt-1">Para detalhamento de procedimentos por AIH:
                            <a href="{{ route('relatorios.aih-pa.index') }}" class="font-medium text-blue-800 underline">Procedimentos AIH →</a>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
            <div class="p-6">
                ...
                <div class="mt-6 flex flex-wrap gap-3">
                    <button id="generate-report" class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700">🔍 Gerar Relatório AIH</button>
            ...
            <div class="p-6">
                ...
                <div id="loading-indicator" class="hidden text-center py-8">
                    <div class="inline-flex items-center">
                        ...
                        <span class="text-gray-600">Processando relatório AIH...</span>
                    </div>
                </div>
                <div id="results-container">
                    <p class="text-gray-500 text-center py-8">Configure os campos e filtros acima e clique em "Gerar Relatório AIH".</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        const loadLookupData     = (field, search) =>
            RelatoriosBase.loadLookupData(field, search, '{{ route("relatorios.aih.lookup") }}');
        ...
        async function loadAvailableFields() {
            ...
            try {
                ...
                const response = await fetch('{{ route("relatorios.aih.fields") }}');
        ...
        async function generateReport(format) {
            ...
            try {
                ...
                if (format === 'html') {
                    ...
                    await handleFileDownload(response, format, 'relatorio_aih.' + (format === 'excel' ? 'xlsx' : format));
                }
            } catch (err) {
