<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Editar Registro de Produção APAC') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('spap.update', $sPap) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <select id="PAP_UID" 
                                    ...
                                    @foreach($prestadores as $prestador)
                                        <option value="{{ $prestador->re_cunid }}" 
                                                {{ (old('PAP_UID', $sPap->PAP_UID) == $prestador->re_cunid) ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <x-text-input id="PAP_NUM" 
                                             ...
                                             :value="old('PAP_NUM', $sPap->PAP_NUM)" 
                                             required />
                            ...
                            <div>
                                ...
                                <x-text-input id="PAP_CMP" 
                                             ...
                                             type="text" 
                                             class="mt-1 block w-full" 
                                             :value="old('PAP_CMP', $sPap->PAP_CMP)" 
                                             placeholder="YYYYMM" />
                                ...
                                <select id="PAP_PA" 
                                    ...
                                    @foreach($procedimentos as $procedimento)
                                        <option value="{{ $procedimento->codigo }}" 
                                                {{ (old('PAP_PA', $sPap->PAP_PA) == $procedimento->codigo) ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <x-text-input id="PAP_SEQ" 
                                             ...
                                             type="text" 
                                             class="mt-1 block w-full" 
                                             :value="old('PAP_SEQ', $sPap->PAP_SEQ)" />
                                ...
                                <select id="PAP_CBO" 
                                    ...
                                    @foreach($cbos as $cbo)
                                        <option value="{{ $cbo->cbo }}" 
                                                {{ (old('PAP_CBO', $sPap->PAP_CBO) == $cbo->cbo) ? 'selected' : '' }}>
                                            {{ $cbo->cbo }} - {{ $cbo->ds_cbo }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <x-text-input id="PAP_IDADE" 
                                             ...
                                             type="number" 
                                             class="mt-1 block w-full" 
                                             :value="old('PAP_IDADE', $sPap->PAP_IDADE)" 
                                             min="0" 
                                             max="150" />
                            ...
                            <div>
                                ...
                                <x-text-input id="PAP_QT_P" 
                                             ...
                                             step="0.01"
                                             class="mt-1 block w-full" 
                                             :value="old('PAP_QT_P', $sPap->PAP_QT_P)" 
                                             min="0" />
                            ...
                            <div>
                                ...
                                <x-text-input id="PAP_QT_A" 
                                             ...
                                             step="0.01"
                                             class="mt-1 block w-full" 
                                             :value="old('PAP_QT_A', $sPap->PAP_QT_A)" 
                                             min="0" />
                            ...
                            <div>
                                ...
                                <x-text-input id="PAP_MVM" 
                                             ...
                                             type="text" 
                                             class="mt-1 block w-full" 
                                             :value="old('PAP_MVM', $sPap->PAP_MVM)" 
                                             placeholder="YYYYMM" />
                            ...
                            <div>
                                ...
                                <x-text-input id="PAP_CIDPRI" 
                                             ...
                                             type="text" 
                                             class="mt-1 block w-full" 
                                             :value="old('PAP_CIDPRI', $sPap->PAP_CIDPRI)" />
                            ...
                            <div>
                                ...
                                <x-text-input id="PAP_CIDSEC" 
                                             ...
                                             type="text" 
                                             class="mt-1 block w-full" 
                                             :value="old('PAP_CIDSEC', $sPap->PAP_CIDSEC)" />
                            ...
                            <div>
                                ...
                                <x-text-input id="PAP_VL_FED" 
                                             ...
                                             step="0.01"
                                             class="mt-1 block w-full" 
                                             :value="old('PAP_VL_FED', $sPap->PAP_VL_FED)" 
                                             min="0" />
                            ...
                            <div>
                                ...
                                <x-text-input id="PAP_VL_LOC" 
                                             ...
                                             step="0.01"
                                             class="mt-1 block w-full" 
                                             :value="old('PAP_VL_LOC', $sPap->PAP_VL_LOC)" 
                                             min="0" />
                            ...
                            <div>
                                ...
                                <x-text-input id="PAP_VL_INC" 
                                             ...
                                             step="0.01"
                                             class="mt-1 block w-full" 
                                             :value="old('PAP_VL_INC', $sPap->PAP_VL_INC)" 
                                             min="0" />
                            ...
                            <div>
                                ...
                                <x-text-input id="PAP_RUB" 
                                             ...
                                             type="text" 
                                             class="mt-1 block w-full" 
                                             :value="old('PAP_RUB', $sPap->PAP_RUB)" />
                            ...
                            <div>
                                ...
                                <select id="PAP_TPFIN" 
                                    ...
                                    <option value="1" {{ (old('PAP_TPFIN', $sPap->PAP_TPFIN) == '1') ? 'selected' : '' }}>Federal</option>
                                    <option value="2" {{ (old('PAP_TPFIN', $sPap->PAP_TPFIN) == '2') ? 'selected' : '' }}>Estadual</option>
                                    <option value="3" {{ (old('PAP_TPFIN', $sPap->PAP_TPFIN) == '3') ? 'selected' : '' }}>Municipal</option>
                                </select>
